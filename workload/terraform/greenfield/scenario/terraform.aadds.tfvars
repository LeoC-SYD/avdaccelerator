...
avdLocation = "westeurope" # default region for AVD service objects
# Optional: override regions per component
# host_location    = "northeurope"       # region for session hosts (and their RG)
# network_location = "northeurope"       # region for VNet/network resources
# log_location     = "northeurope"       # region for Log Analytics (and its RG)
...
aad_group_name       = "avdusersgroup"               #user group must pre-created on your AD server and sync to Microsoft Entra ID
aadds_domain_name    = "contoso.com"
aadds_username       = "aaddsadmin"
# aadds_password        = "P@ssw0rd!"    # optional: provide to use a specific password
hub_vnet                  = "infra-network"
hub_connectivity_rg       = "infra-rg"
hub_dns_zone_rg           = "js-privatedns"
rdsh_count                = 2
next_hop_ip               = "10.100.0.4" # next hop ip address
fw_policy                 = "fwpol-hub"  # fw policy name
image_name                = "avdImage-microsoftwindowsdesktop-office-365-win11-23h2-avd-m365"
...
identity_subscription_id  = "Your Hub Subscription ID"
avdshared_subscription_id = "Your Hub Subscription ID"
